...
<div class="mb-3">
    <label for="nama" class="form-label">Nama</class=>
    <input type="text" class="form-control" id="nama" name="nama" value="{{isset($siswa)?$siswa->nama_siswa: ''}}">
</div>
<div class="mb-3">
<label for="alamat" class="form-label">Alamat</label><textarea class="form-control" id="alamat" name="alamat" rows="3">{{ isset($siswa) ? $siswa->alamat_siswa : '' }}</textarea>
      </div>
